...
from evaluation_platform.experiment_config import CODE_TEAM
...
class CodeTeamAgent(BaseInstalledAgent):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        self.hyperparameters = CODE_TEAM.resolve(hyperparameters)
    ...
    async def install(self, environment: BaseEnvironment) -> None:
        ...
        for module in ("run_code_team.py", "model_usage.py"):
    ...
    async def run(
        ...
        with TemporaryDirectory() as temp_dir:
            ...
            await self.exec_as_agent(
                environment,
                command=(
                    "python /installed-agent/run_code_team.py "
