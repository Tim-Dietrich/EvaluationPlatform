...
%\presetkeys{todonotes}{disable}{} % USE THIS COMMAND TO DEACTIVE TODO NOTES
\usepackage{caption}
...
% Colorbox, used for notes, can be removed later as these are only really used for TODOs atm
...
\newcommand{\thesisTitle}{Valide Quellcode-Generierung aus Userstories mit LLM} 
...
\newcommand{\thesisName}{Tim Dietrich}
\newcommand{\thesisSubject}{Master Projekt}
...
\newcommand{\controlquestionsbase}[2]{\todo[inline,caption={#2},linecolor=Plum,backgroundcolor=yellow!50,bordercolor=Plum]{#1}}
\newcommand{\controlquestions}[1]{\controlquestionsbase{#1}{Kontrollfragen}}
\newcommand{\controlquestionscontinue}[1]{\controlquestionsbase{#1}{Kontrollfragen (Fortsetzung)}}
...
% MY CUSTOM COMMANDS
\newcommand{\rqref}[1]{\hyperref[#1]{\color{ctcolorlistlabel}\tgherosfont\textbf{#1}}}
\newcommand{\tabref}[1]{\hyperref[#1]{\color{ctcolorfloatlabel}\sffamily\textbf{Tabelle~\ref*{#1}}}}
...
% Additional bibtex files are added here to cleanly sepparate them
\addbibresource{bibtex/code_generation.bib}
\addbibresource{bibtex/evaluation.bib}
\addbibresource{bibtex/others.bib}
\addbibresource{bibtex/prompts.bib}
...
% Test imports for sankey diagram
% \usepackage{tikz}
% \usepackage{sankey}

\newcounter{lastenumcounter}
